...
- Data Structures
    ...
    - Trees
        - [Two Pointers](data_structures/two-pointer.md)
...
- Geometry
    ...
    - Miscellaneous
        ...
        - [Half-plane intersection - S&I Algorithm in O(N log N) (Fixed Maybe)](geometry/halfplane-intersection-maybe-fixed.md)
